...
const ArenaCarousel:React.FC = () => {
    const arenas: Arena[] = [
        {
            ...
            arena_description: "Welcome to Arena I — where semicolons are friendly, bugs are shy, and your keyboard still likes you. Think of it as a coding smoothie: tasty, healthy, and doesn't bite back. Great for stretching those logic muscles without pulling a brain-hamstring."
        },
        {
            arena_level: 2,
            arena_name: "LOGIC-LABYRINTH",
            arena_description: "Now you're in the mid-tier maze. Arena II turns the dial up — more edge cases, sneakier constraints, and the occasional 'Why is this failing test case ruining my day?' It's the sweet spot where newbies feel bold and veterans feel... slightly nervous."
        },
        {
            arena_level: 3,
            arena_name: "THE BOSS BATTLE",
            arena_description: "This is it. Arena III. Where recursion meets regret, and time complexity is your final boss. Only the brave, caffeinated, and slightly unhinged enter here. May your stack never overflow and your code always compile on the first try (lol)"
        }
    ];
    ...
    return (
        <div className={`${styles["arena-carousel-wrapper"]} flex-row justify-content-center align-items-center`}>
            <div 
                onClick={goBack}

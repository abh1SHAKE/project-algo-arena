        ...
        <div className={`${styles["problem-details-container"]} flex-column gap-12`}>
            ...
            <div className={`${styles["description-and-examples"]} flex-column gap-28`}>
                <div className={`${styles["problem-description"]} flex-column gap-12`}>
                    <div 
                        dangerouslySetInnerHTML={createMarkup(problemData.problem_description)}
                    />
                </div>
                <div className={`${styles["problem-examples"]} flex-column gap-20`}>
                    {problemData.problem_examples.map((example, index) => (
                        <div key={index} className={`${styles["example"]} flex-column gap-8`}>
                            Example {index + 1}:
                            <div>
                                <strong>Input: </strong>
                                {example.input}
                            ...
                            <div>
                                ...
                                <div dangerouslySetInnerHTML={createMarkup(example.explanation)} />
                            </div>
                        </div>
                    ))}
                </div>
